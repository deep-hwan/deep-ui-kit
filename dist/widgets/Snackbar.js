...
var CancelTab = styled.button(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  z-index: 999;\n  position: absolute;\n  top: 10px;\n  right: 10px;\n  width: 17px;\n  min-width: 17px;\n  height: 17px;\n  min-height: 17px;\n  display: flex;\n  align-items: center;\n  user-select: none;\n  transition: 0.3s ease-in-out;\n  border: none;\n  background-color: transparent;\n  justify-content: center;\n  cursor: pointer;\n  outline: none;\n\n  svg {\n    width: 17px;\n    min-width: 17px;\n    height: 17px;\n    min-height: 17px;\n    fill: ", ";\n    transition: 0.25s ease-in-out;\n  }\n"], ["\n  z-index: 999;\n  position: absolute;\n  top: 10px;\n  right: 10px;\n  width: 17px;\n  min-width: 17px;\n  height: 17px;\n  min-height: 17px;\n  display: flex;\n  align-items: center;\n  user-select: none;\n  transition: 0.3s ease-in-out;\n  border: none;\n  background-color: transparent;\n  justify-content: center;\n  cursor: pointer;\n  outline: none;\n\n  svg {\n    width: 17px;\n    min-width: 17px;\n    height: 17px;\n    min-height: 17px;\n    fill: ", ";\n    transition: 0.25s ease-in-out;\n  }\n"])), function (_a) {
    var theme = _a.theme;
