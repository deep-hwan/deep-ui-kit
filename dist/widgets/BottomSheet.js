...
function BottomSheet(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(LayerBlur, { isActive: view }), (0, jsx_runtime_1.jsxs)(Sheet, __assign({ theme: theme, isActive: view, ref: ref, style: { transform: "translate(-50%, ".concat(currentY - startY, "px)") } }, { children: [(0, jsx_runtime_1.jsx)(CloseBox, __assign({ theme: theme }, { children: (0, jsx_runtime_1.jsx)("button", { type: "button", onClick: onCancel, onTouchStart: handleTouchStart, onTouchMove: handleTouchMove, onTouchEnd: handleTouchEnd }) })), (0, jsx_runtime_1.jsx)(View, { children: children })] }))] }));
}
