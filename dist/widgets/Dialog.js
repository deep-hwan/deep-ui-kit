...
var DialogView = styled_1.default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  z-index: 99999;\n  position: fixed;\n  top: ", ";\n  left: 50%;\n  transform: ", ";\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  padding: 20px;\n  opacity: ", ";\n  transition: 0.25s ease-in-out;\n\n  &::-webkit-scrollbar {\n    display: none;\n  }\n"], ["\n  z-index: 99999;\n  position: fixed;\n  top: ", ";\n  left: 50%;\n  transform: ", ";\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  padding: 20px;\n  opacity: ", ";\n  transition: 0.25s ease-in-out;\n\n  &::-webkit-scrollbar {\n    display: none;\n  }\n"])), function (_a) {
    var isActive = _a.isActive;
...
var CancelTab = styled_1.default.button(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  z-index: 999;\n  position: absolute;\n  top: 10px;\n  right: 10px;\n  width: 22px;\n  min-width: 22px;\n  height: 22px;\n  min-height: 22px;\n  display: flex;\n  justify-content: center;\n  cursor: pointer;\n  align-items: center;\n  user-select: none;\n  transition: 0.3s ease-in-out;\n  border: none;\n  cursor: pointer;\n  background-color: transparent;\n  outline: none;\n  transition: 0.25s ease-in-out;\n\n  svg {\n    width: 22px;\n    min-width: 22px;\n    height: 22px;\n    min-height: 22px;\n    fill: ", ";\n    transition: 0.25s ease-in-out;\n  }\n"], ["\n  z-index: 999;\n  position: absolute;\n  top: 10px;\n  right: 10px;\n  width: 22px;\n  min-width: 22px;\n  height: 22px;\n  min-height: 22px;\n  display: flex;\n  justify-content: center;\n  cursor: pointer;\n  align-items: center;\n  user-select: none;\n  transition: 0.3s ease-in-out;\n  border: none;\n  cursor: pointer;\n  background-color: transparent;\n  outline: none;\n  transition: 0.25s ease-in-out;\n\n  svg {\n    width: 22px;\n    min-width: 22px;\n    height: 22px;\n    min-height: 22px;\n    fill: ", ";\n    transition: 0.25s ease-in-out;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return (theme === "dark" ? "#404040" : "#e0e0e0");
});
var View = styled_1.default.div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  width: 100%;\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n"], ["\n  width: 100%;\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n"])));
